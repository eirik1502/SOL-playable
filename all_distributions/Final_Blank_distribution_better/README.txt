SOL distribution from the end of the project at Blank (03.06.17).
This "better" version is barely edited in 2018 by removing system prints.
It was a system print occuring every frame on the server,
which might be a reason for decreased performance when not run through a terminal (just by dobbelckicking).
Whene there is no terminal, it is believed that a system out print is slower.
